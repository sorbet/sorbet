...
TEST_CASE("Condensation Graph - Four packages without deps") {
    ...
    auto parsedFiles = enterPackages(gs, {{"lib/foo/a/__package.rb", makePackageRB("Lib::Foo::A", "layered", "lib")},
                                          {"lib/foo/b/__package.rb", makePackageRB("Lib::Foo::B", "layered", "lib")},
                                          {"lib/foo/c/__package.rb", makePackageRB("Lib::Foo::C", "layered", "lib")},
                                          {"lib/foo/d/__package.rb", makePackageRB("Lib::Foo::D", "layered", "lib")}});
...
TEST_CASE("Condensation Graph - Four packages with a cycle of three") {
    ...
    auto parsedFiles = enterPackages(
        ...
        {{"lib/foo/a/__package.rb", makePackageRB("Lib::Foo::A", "layered", "lib", {"Lib::Foo::B"}, {"Lib::Foo::B"})},
         {"lib/foo/b/__package.rb", makePackageRB("Lib::Foo::B", "layered", "lib", {"Lib::Foo::D"}, {"Lib::Foo::C"})},
         {"lib/foo/c/__package.rb", makePackageRB("Lib::Foo::C", "layered", "lib", {"Lib::Foo::B"}, {})},
         {"lib/foo/d/__package.rb", makePackageRB("Lib::Foo::D", "layered", "lib", {"Lib::Foo::A"}, {})}});

    auto &condensation = gs.packageDB().condensation();
    auto traversal = condensation.computeTraversal(gs);

    auto pkgA = packageInfoFor(gs, parsedFiles[0].file).mangledName();
    auto pkgB = packageInfoFor(gs, parsedFiles[1].file).mangledName();
    auto pkgC = packageInfoFor(gs, parsedFiles[2].file).mangledName();
    auto pkgD = packageInfoFor(gs, parsedFiles[3].file).mangledName();
