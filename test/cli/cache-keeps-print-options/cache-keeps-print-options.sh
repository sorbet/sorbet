...
main/sorbet --silence-dev-message --censor-raw-locs-within-payload -p symbol-table --cache-dir="$CACHE" test/cli/cache-keeps-print-options/cache-keeps-print-options.rb 2>/dev/null
main/sorbet --silence-dev-message --censor-raw-locs-within-payload -p symbol-table --cache-dir="$CACHE" test/cli/cache-keeps-print-options/cache-keeps-print-options.rb 2>/dev/null
rm -rf "$CACHE"/*.mdb
