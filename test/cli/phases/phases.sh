...
for p in parse-tree parse-tree-json desugar-tree desugar-tree-raw dsl-tree dsl-tree-raw index-tree index-tree-raw name-tree name-tree-raw resolve-tree resolve-tree-raw flatten-tree flatten-tree-raw ast ast-raw cfg cfg-raw cfg-json symbol-table symbol-table-raw; do
    echo "--- $p start ---"
