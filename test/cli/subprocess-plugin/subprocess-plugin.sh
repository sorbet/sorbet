...
main/sorbet --silence-dev-message --censor-raw-locs-within-payload --dsl-plugins test/cli/subprocess-plugin/multi.yaml --print symbol-table test/cli/subprocess-plugin/multi*.rb
