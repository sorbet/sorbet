...
main/sorbet --silence-dev-message --censor-for-snapshot-tests --dsl-plugins test/cli/subprocess-plugin/multi.yaml --print symbol-table test/cli/subprocess-plugin/multi*.rb
