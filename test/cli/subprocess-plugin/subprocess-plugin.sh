...
main/sorbet --silence-dev-message --censor-for-symbol-table-exp --dsl-plugins test/cli/subprocess-plugin/multi.yaml --print symbol-table test/cli/subprocess-plugin/multi*.rb
