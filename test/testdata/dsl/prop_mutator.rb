...
Foo::Mutator.new.t_hash_type['a'] = 'b' # error: `String("a")` does not match `Symbol` for argument `key`
Foo::Mutator.new.t_hash_type[:a] = :b # error: `Symbol(:"b")` does not match `String` for argument `value`
Foo::Mutator.new.array << :a
Foo::Mutator.new.t_array << 'a'
Foo::Mutator.new.t_array << :a
Foo::Mutator.new.t_array_type << 'a'
Foo::Mutator.new.t_array_type << :a # error: `Symbol(:"a")` does not match `String` for argument `value`
