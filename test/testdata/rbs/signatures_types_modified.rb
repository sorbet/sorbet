...
# Modified for Prism: NilClass is represented as `<emptyTree>::<C NilClass>`
# instead of `::NilClass` due to differences in AST node types
# (PM_CONSTANT_READ_NODE vs parser::ResolvedConst)
