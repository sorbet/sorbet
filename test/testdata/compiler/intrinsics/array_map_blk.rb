...
# variant of `sorbet_callIntrinsicInlineBlock`, and the second does not. Additionally, in the optimized output, we
# should see exactly one call to `rb_iterate` in the Init function, as the root static init will be inlined there.
