...
# The k/v here are chosen to force "cleanse_tag" to do some work. See also format_tag_no_cleansing.rb.
module M
  sig{void}
  def self.do_test
    k = 'helloWorld.thisTag**fortytwo'
    v = "{}#*@)*U)QWFNDOJVNZSFJS...)FEWJWF)(#UJ#@)GIJNOIU..___--___%@$(*!@&($+_+_+_s=DF{}{A{}SF{}AF}}"
