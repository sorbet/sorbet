...
class RSpecIncludeContextTest
  ...
  RSpec.describe 'nonexistent context' do
    include_context 'nonexistent context' # error-with-dupes: Unable to resolve constant `<shared_examples_module 'nonexistent context'>`
  end

  RSpec.describe 'working include_context' do
