...
T.assert_type!(Module.private_class_method([:foo, :bar]), T::Array[Symbol])
T.assert_type!(Module.private_class_method(["foo", "bar"]), T::Array[String])
T.assert_type!(Module.private_class_method(:foo), Symbol)
T.assert_type!(Module.private_class_method("bar"), String)
