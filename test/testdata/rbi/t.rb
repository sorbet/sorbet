# typed: strict
T::InterfaceWrapper.dynamic_cast(nil, String)
T.let("foo", String)
...
T::InterfaceWrapper.dynamic_cast # error: Not enough arguments provided for method `T::InterfaceWrapper.dynamic_cast`. Expected: `2`, got: `0`
