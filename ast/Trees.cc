...
UnresolvedConstantLit::ForwardRange::iterator&
UnresolvedConstantLit::ForwardRange::iterator::operator++() {
    ++index_;
    return *this;
}

UnresolvedConstantLit::ForwardRange::iterator
UnresolvedConstantLit::ForwardRange::iterator::operator++(int) {
    iterator tmp = *this;
    ++index_;
    return tmp;
}
...
UnresolvedConstantLit::ReverseRange::ReverseRange(const UnresolvedConstantLit* node)
    : node_(node) {}
...
UnresolvedConstantLit::ReverseRange::iterator::iterator(const UnresolvedConstantLit* node)
    : current_(node) {
    if (current_) {
...
UnresolvedConstantLit::ReverseRange::iterator&
UnresolvedConstantLit::ReverseRange::iterator::operator++() {
    advance();
    return *this;
}

UnresolvedConstantLit::ReverseRange::iterator
UnresolvedConstantLit::ReverseRange::iterator::operator++(int) {
    iterator tmp = *this;
    advance();
    return tmp;
}
