...
private:
    ...
    ast::ExpressionPtr translateConst(const pm_constant_id_t &nodeName, const pm_location_t &baseLocation,
                                      bool isConstantPath, pm_node_t *parent, const pm_location_t *nodeDelimLoc);
