...
public:
    Translator(const Parser &parser, core::MutableContext ctx, absl::Span<const ParseError> parseErrors,
        ...
        : parser(parser), ctx(ctx), parseErrors(parseErrors), preserveConcreteSyntax(preserveConcreteSyntax),
          uniqueCounterStorage(1), uniqueCounter(this->uniqueCounterStorage), enclosingBlockParamLoc(enclosingBlockParamLoc),
...
private:
    ...
    Translator(const Translator &parent, bool resetUniqueCounter, core::LocOffsets enclosingMethodLoc,
        ...
        : parser(parent.parser), ctx(parent.ctx), parseErrors(parent.parseErrors),
          preserveConcreteSyntax(parent.preserveConcreteSyntax), uniqueCounterStorage(resetUniqueCounter ? 1 : 999999),
