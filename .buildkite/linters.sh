...
if [ "$err" -ne 0 ]; then
    (echo '<pre class="term"><code>'; cat buildifier; echo '</code></pre>') > buildifier_wrapped
...
if [ "$err" -ne 0 ]; then
    (echo '<pre class="term"><code>'; cat format_cxx; echo '</code></pre>') > format_cxx_wrapped
...
if [ "$err" -ne 0 ]; then
    (echo '<pre class="term"><code>'; cat compdb; echo '</code></pre>') > compdb_wrapped
...
if [ "$err" -ne 0 ]; then
    (echo '<pre class="term"><code>'; cat compdb-targets; echo '</code></pre>') > compdb-targets_wrapped
...
if [ "$err" -ne 0 ]; then
    (echo '<pre class="term"><code>'; cat std_check; echo '</code></pre>') > std_check_wrapped
...
if [ "$err" -ne 0 ]; then
    (echo '<pre class="term"><code>'; cat lint_sh; echo '</code></pre>') > lint_sh_wrapped
