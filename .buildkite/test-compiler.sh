...
if [ "$err" -ne 0 ]; then
  ...
  ls -R bazel-out/k8-opt/bin/test/testdata/compiler/intrinsics/t_must.sorbet.build/
  cp bazel-out/k8-opt/bin/test/testdata/compiler/intrinsics/t_must.sorbet.build/test/testdata/compiler/intrinsics/t_must/t_must.rb.opt.ll _out_
