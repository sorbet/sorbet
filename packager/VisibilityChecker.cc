...
class VisibilityCheckerPass final {
    void addImportInfo(core::Context ctx, core::ErrorBuilder &e) {
    ...
    void addErrorInfo(core::Context ctx, core::ErrorBuilder &e, core::SymbolRef litSymbol) {
