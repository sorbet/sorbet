...
# [`Set`](https://docs.ruby-lang.org/en/2.6.0/Set.html) implements a collection
...
#
# [`Set`](https://docs.ruby-lang.org/en/2.6.0/Set.html) is easy to use with
...
# [`Enumerable`](https://docs.ruby-lang.org/en/2.6.0/Enumerable.html) object can
# be converted to [`Set`](https://docs.ruby-lang.org/en/2.6.0/Set.html) using
# the `to_set` method.
#
# [`Set`](https://docs.ruby-lang.org/en/2.6.0/Set.html) uses
# [`Hash`](https://docs.ruby-lang.org/en/2.6.0/Hash.html) as storage, so you
...
#     and Object#hash. Use
#     [`Set#compare_by_identity`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-compare_by_identity)
#     to make a set compare its elements by their identity.
# *   [`Set`](https://docs.ruby-lang.org/en/2.6.0/Set.html) assumes that the
...
class Set < Object
  ...
  # Alias for: [`|`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-7C)
  sig do
    params(
  ...
  #
  # Also aliased as:
  # [`<<`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-3C-3C)
  sig do
    params(
        o: Elem,
    )
  ...
  # Alias for: [`-`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-2D)
  sig do
    params(
        enum: T::Enumerable[Elem],
    )
  ...
  # Equivalent to
  # [`Set#flatten`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-flatten),
  ...
  # Alias for: [`&`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-26)
  sig do
    params(
        enum: T::Enumerable[Elem],
    )
  ...
  # Alias for:
  # [`collect!`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-collect-21)
  sig do
    type_parameters(:U).params(
  ...
  # Alias for:
  # [`include?`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-include-3F)
  sig do
    params(
        o: Elem,
    )
  ...
  #
  # Also aliased as:
  # [`<`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-3C)
  sig do
    params(
        set: T::Set[Elem],
    )
  ...
  #
  # Also aliased as:
  # [`>`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-3E)
  sig do
    params(
        set: T::Set[Elem],
    )
  ...
  # Equivalent to
  # [`Set#delete_if`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-delete_if),
  ...
  # Equivalent to
  # [`Set#keep_if`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-keep_if),
  # but returns nil if no changes were made. Returns an enumerator if no block
  # is given.
  #
  # Also aliased as:
  # [`filter!`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-filter-21)
  sig do
    params(
        blk: T.proc.params(arg0: Elem).returns(BasicObject),
    )
  ...
  #
  # Also aliased as:
  # [`length`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-length)
  sig {returns(Integer)}
  def size(); end
  ...
  #
  # Also aliased as:
  # [`<=`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-3C-3D)
  sig do
    params(
        set: T::Set[Elem],
    )
  ...
  #
  # Also aliased as:
  # [`>=`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-3E-3D)
  sig do
    params(
        set: T::Set[Elem],
    )
  ...
  #
  # Also aliased as:
  # [`intersection`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-intersection)
  sig do
    params(
        enum: T::Enumerable[Elem],
    )
  ...
  #
  # Also aliased as:
  # [`difference`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-difference)
  sig do
    params(
        enum: T::Enumerable[Elem],
    )
  ...
  # Alias for:
  # [`proper_subset?`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-proper_subset-3F)
  sig do
    params(
        set: T::Set[Elem],
    )
  ...
  # Alias for:
  # [`add`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-add)
  sig do
    params(
        o: Elem,
    )
  ...
  # Alias for:
  # [`subset?`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-subset-3F)
  sig do
    params(
        set: T::Set[Elem],
    )
  ...
  # Alias for:
  # [`proper_superset?`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-proper_superset-3F)
  sig do
    params(
        set: T::Set[Elem],
    )
  ...
  # Alias for:
  # [`superset?`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-superset-3F)
  sig do
    params(
        set: T::Set[Elem],
    )
  ...
  #
  # Also aliased as:
  # [`map!`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-map-21)
  sig do
    type_parameters(:U).params(
        blk: T.proc.params(arg0: Elem).returns(T.type_parameter(:U)),
    )
  ...
  #
  # Also aliased as:
  # [`member?`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-member-3F),
  # [`===`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-3D-3D-3D)
  sig do
    params(
        o: Elem,
    )
  ...
  # Alias for:
  # [`size`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-size)
  sig {returns(Integer)}
  def length(); end
  ...
  #
  # Also aliased as:
  # [`+`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-2B),
  # [`union`](https://docs.ruby-lang.org/en/2.6.0/Set.html#method-i-union)
  sig do
    params(
        enum: T::Enumerable[Elem],
    )
...
# [`SortedSet`](https://docs.ruby-lang.org/en/2.6.0/SortedSet.html) implements a
# [`Set`](https://docs.ruby-lang.org/en/2.6.0/Set.html) that guarantees that its
# elements are yielded in sorted order (according to the return values of their
# #<=> methods) when iterating over them.
#
# All elements that are added to a
# [`SortedSet`](https://docs.ruby-lang.org/en/2.6.0/SortedSet.html) must respond
...
# [`ArgumentError`](https://docs.ruby-lang.org/en/2.6.0/ArgumentError.html) will
# be raised when iterating over the
# [`SortedSet`](https://docs.ruby-lang.org/en/2.6.0/SortedSet.html).
#
# ## Example
#
# ```ruby
