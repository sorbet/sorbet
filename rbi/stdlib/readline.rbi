...
# The [`Readline`](https://docs.ruby-lang.org/en/2.7.0/Readline.html) module
# provides interface for GNU
# [`Readline`](https://docs.ruby-lang.org/en/2.7.0/Readline.html). This module
...
#
# GNU [`Readline`](https://docs.ruby-lang.org/en/2.7.0/Readline.html)
...
# [`Readline.readline`](https://docs.ruby-lang.org/en/2.7.0/Readline.html#method-c-readline)
...
# can be accessed by
# [`Readline::HISTORY`](https://docs.ruby-lang.org/en/2.7.0/Readline.html#HISTORY)
# constant.
#
# ```ruby
# require "readline"
...
module Readline
  ...
  # The [`Object`](https://docs.ruby-lang.org/en/2.7.0/Object.html) with the
  # call method that is a completion for filename. This is sets by
  # [`Readline.completion_proc=`](https://docs.ruby-lang.org/en/2.7.0/Readline.html#method-c-completion_proc-3D)
  # method.
  ...
  # [`Readline`](https://docs.ruby-lang.org/en/2.7.0/Readline.html) or libedit.
  ...
  # [`Readline.completer_word_break_characters`](https://docs.ruby-lang.org/en/2.7.0/Readline.html#method-c-completer_word_break_characters)
  ...
  # [`Readline.basic_word_break_characters`](https://docs.ruby-lang.org/en/2.7.0/Readline.html#method-c-basic_word_break_characters).
  #
  # Raises
  # [`NotImplementedError`](https://docs.ruby-lang.org/en/2.7.0/NotImplementedError.html)
  # if the using readline library does not support.
  ...
  # [`Readline.completion_case_fold=`](https://docs.ruby-lang.org/en/2.7.0/Readline.html#method-c-completion_case_fold-3D)
  # method.
  #
  # ```ruby
  # require "readline"
  ...
  # Specifies a [`Proc`](https://docs.ruby-lang.org/en/2.7.0/Proc.html) object
  ...
  #
  # The [`String`](https://docs.ruby-lang.org/en/2.7.0/String.html) that is
  # passed to the [`Proc`](https://docs.ruby-lang.org/en/2.7.0/Proc.html)
  # depends on the
  # [`Readline.completer_word_break_characters`](https://docs.ruby-lang.org/en/2.7.0/Readline.html#method-c-completer_word_break_characters)
  # property. By default the word under the cursor is passed to the
  # [`Proc`](https://docs.ruby-lang.org/en/2.7.0/Proc.html). For example, if the
  # input is "foo bar" then only "bar" would be passed to the completion
  # [`Proc`](https://docs.ruby-lang.org/en/2.7.0/Proc.html).
  #
  # Upon successful completion the
  # [`Readline.completion_append_character`](https://docs.ruby-lang.org/en/2.7.0/Readline.html#method-c-completion_append_character)
  ...
  # examples
  # [`Enumerator.grep`](https://docs.ruby-lang.org/en/2.7.0/Enumerable.html#method-i-grep)
  # is used. The input is escaped to prevent
  # [`Regexp`](https://docs.ruby-lang.org/en/2.7.0/Regexp.html) special
  # characters from interfering with the matching.
  #
  # It may also be helpful to use the
  # [`Abbrev`](https://docs.ruby-lang.org/en/2.7.0/Abbrev.html) library to
  ...
  # GNU [`Readline`](https://docs.ruby-lang.org/en/2.7.0/Readline.html) for
  ...
  # Specifies a [`File`](https://docs.ruby-lang.org/en/2.7.0/File.html) object
  ...
  # passed to
  # [`completion_proc`](https://docs.ruby-lang.org/en/2.7.0/Readline.html#method-c-completion_proc)
  ...
  # [`Set`](https://docs.ruby-lang.org/en/2.7.0/Set.html) the index of the
  ...
  #
  # [`Readline`](https://docs.ruby-lang.org/en/2.7.0/Readline.html) will only
  ...
  # [`Readline`](https://docs.ruby-lang.org/en/2.7.0/Readline.html) will not
  ...
  # [`Set`](https://docs.ruby-lang.org/en/2.7.0/Set.html) terminal size to
  # `rows` and `columns`.
  #
  ...
  # [`Readline`](https://docs.ruby-lang.org/en/2.7.0/Readline.html) for details
  # of VI editing mode.
  #
  # Raises
  # [`NotImplementedError`](https://docs.ruby-lang.org/en/2.7.0/NotImplementedError.html)
