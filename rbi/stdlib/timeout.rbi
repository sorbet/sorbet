...
# [`Timeout`](https://docs.ruby-lang.org/en/2.6.0/Timeout.html) long-running
# blocks
#
# ## Synopsis
#
...
# ## Description
#
# [`Timeout`](https://docs.ruby-lang.org/en/2.6.0/Timeout.html) provides a way
# to auto-terminate a potentially long-running operation if it hasn't finished
# in a fixed amount of time.
#
# Previous versions didn't use a module for namespacing, however
# [`timeout`](https://docs.ruby-lang.org/en/2.6.0/Timeout.html#method-i-timeout)
...
module Timeout
  ...
  #     [`Class`](https://docs.ruby-lang.org/en/2.6.0/Class.html) to raise if
  ...
  # `message`
  # :   Error message to raise with
  #     [`Exception`](https://docs.ruby-lang.org/en/2.6.0/Exception.html)
  #     [`Class`](https://docs.ruby-lang.org/en/2.6.0/Class.html). Omitting will
  ...
  # [`Timeout`](https://docs.ruby-lang.org/en/2.6.0/Timeout.html), so you can
