...
# [`PStore`](https://docs.ruby-lang.org/en/2.7.0/PStore.html) implements a file
# based persistence mechanism based on a
# [`Hash`](https://docs.ruby-lang.org/en/2.7.0/Hash.html). User code can store
...
# [`Marshal`](https://docs.ruby-lang.org/en/2.7.0/Marshal.html). That carries
# the usual limitations. [`Proc`](https://docs.ruby-lang.org/en/2.7.0/Proc.html)
...
# [`PStore`](https://docs.ruby-lang.org/en/2.7.0/PStore.html) is writing to its
...
# [`PStore`](https://docs.ruby-lang.org/en/2.7.0/PStore.html), then you should
# backup the [`PStore`](https://docs.ruby-lang.org/en/2.7.0/PStore.html) files
# from time to time.
class PStore
  ...
  # [`PStore`](https://docs.ruby-lang.org/en/2.7.0/PStore.html) file data, by
  # *name*. The hierarchy of Ruby objects stored under that root *name* will be
  # returned.
  #
  # **WARNING**:  This method is only valid in a
  # [`PStore#transaction`](https://docs.ruby-lang.org/en/2.7.0/PStore.html#method-i-transaction).
  # It will raise
  # [`PStore::Error`](https://docs.ruby-lang.org/en/2.7.0/PStore/Error.html) if
  ...
  # [`PStore#[]`](https://docs.ruby-lang.org/en/2.7.0/PStore.html#method-i-5B-5D),
  ...
  # [`PStore::Error`](https://docs.ruby-lang.org/en/2.7.0/PStore/Error.html)
  ...
  # [`PStore#commit`](https://docs.ruby-lang.org/en/2.7.0/PStore.html#method-i-commit)
  # or
  # [`PStore#abort`](https://docs.ruby-lang.org/en/2.7.0/PStore.html#method-i-abort).
  # See those methods for details about how changes are handled. Raising an
  # uncaught [`Exception`](https://docs.ruby-lang.org/en/2.7.0/Exception.html)
  ...
  # [`PStore::Error`](https://docs.ruby-lang.org/en/2.7.0/PStore/Error.html).
  #
  # Note that [`PStore`](https://docs.ruby-lang.org/en/2.7.0/PStore.html) does
  # not support nested transactions.
  def transaction(read_only = false); end

  # Whether [`PStore`](https://docs.ruby-lang.org/en/2.7.0/PStore.html) should
  ...
  # To construct a [`PStore`](https://docs.ruby-lang.org/en/2.7.0/PStore.html)
...
# [`PStore`](https://docs.ruby-lang.org/en/2.7.0/PStore.html) methods.
