...
# [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html) provides
...
#
# Because [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html) is
# more accurate than normal binary floating point arithmetic, it requires some
# special values.
#
# ### Infinity
#
# [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html) sometimes
...
# [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html) using the
...
# [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html) within the
...
# [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html) value of
...
# [`to_d`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#method-i-to_d)
# method will be available on
# [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html) and the
# native [`Integer`](https://docs.ruby-lang.org/en/2.6.0/Integer.html),
# [`Float`](https://docs.ruby-lang.org/en/2.6.0/Float.html),
# [`Rational`](https://docs.ruby-lang.org/en/2.6.0/Rational.html), and
# [`String`](https://docs.ruby-lang.org/en/2.6.0/String.html) classes:
#
# ```ruby
...
#
# [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html) is
...
class BigDecimal < Numeric
  ...
  # [`BASE`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#BASE) is 10000,
  ...
  # [`Marshal`](https://docs.ruby-lang.org/en/2.6.0/Marshal.html) module.
  sig {params(p1: T.untyped).returns(T.untyped)}
  def self._load(p1); end

  # The
  # [`BigDecimal.double_fig`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#method-c-double_fig)
  # class method returns the number of digits a
  # [`Float`](https://docs.ruby-lang.org/en/2.6.0/Float.html) number is allowed
  ...
  # [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html) numbers
  ...
  # exceptions:
  #
  # [`BigDecimal::EXCEPTION_NaN`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#EXCEPTION_NaN)
  # [`BigDecimal::EXCEPTION_INFINITY`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#EXCEPTION_INFINITY)
  # [`BigDecimal::EXCEPTION_UNDERFLOW`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#EXCEPTION_UNDERFLOW)
  # [`BigDecimal::EXCEPTION_OVERFLOW`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#EXCEPTION_OVERFLOW)
  # [`BigDecimal::EXCEPTION_ZERODIVIDE`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#EXCEPTION_ZERODIVIDE)
  # [`BigDecimal::EXCEPTION_ALL`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#EXCEPTION_ALL)
  #
  ...
  #
  # [`EXCEPTION_NaN`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#EXCEPTION_NaN)
  # :   NaN
  # [`EXCEPTION_INFINITY`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#EXCEPTION_INFINITY)
  # :   +Infinity or -Infinity
  # [`EXCEPTION_UNDERFLOW`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#EXCEPTION_UNDERFLOW)
  # :   0
  # [`EXCEPTION_OVERFLOW`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#EXCEPTION_OVERFLOW)
  # :   +Infinity or -Infinity
  # [`EXCEPTION_ZERODIVIDE`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#EXCEPTION_ZERODIVIDE)
  # :   +Infinity or -Infinity
  #
  #
  # One value of the mode parameter controls the rounding of numeric values:
  # [`BigDecimal::ROUND_MODE`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#ROUND_MODE).
  # The values it can take are:
  #
  # [`ROUND_UP`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#ROUND_UP), :up
  # :   round away from zero
  # [`ROUND_DOWN`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#ROUND_DOWN), :down, :truncate
  # :   round towards zero (truncate)
  # [`ROUND_HALF_UP`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#ROUND_HALF_UP), :half\_up, :default
  # :   round towards the nearest neighbor, unless both neighbors are
  #     equidistant, in which case round away from zero. (default)
  # [`ROUND_HALF_DOWN`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#ROUND_HALF_DOWN), :half\_down
  # :   round towards the nearest neighbor, unless both neighbors are
  #     equidistant, in which case round towards zero.
  # [`ROUND_HALF_EVEN`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#ROUND_HALF_EVEN), :half\_even, :banker
  # :   round towards the nearest neighbor, unless both neighbors are
  #     equidistant, in which case round towards the even neighbor (Banker's
  #     rounding)
  # [`ROUND_CEILING`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#ROUND_CEILING), :ceiling, :ceil
  # :   round towards positive infinity (ceil)
  # [`ROUND_FLOOR`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#ROUND_FLOOR), :floor
  ...
  #
  # If `b` is a [`Float`](https://docs.ruby-lang.org/en/2.6.0/Float.html), the
  ...
  # for [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html).
  #
  ...
  # [`Method`](https://docs.ruby-lang.org/en/2.6.0/Method.html) used to provide
  # marshalling support.
  #
  # ```ruby
  ...
  # ```
  #
  # See the [`Marshal`](https://docs.ruby-lang.org/en/2.6.0/Marshal.html)
  # module.
  sig {returns(String)}
  def _dump(); end
  ...
  # a [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html) and an
  # object of another type, if the other object can be coerced into a
  # [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html) value.
  #
  # e.g.
  #
  # ```ruby
  ...
  # [`String`](https://docs.ruby-lang.org/en/2.6.0/String.html) to a
  # [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html) is not
  ...
  #     [`quo`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#method-i-quo).
  #
  #     If digits is not specified, the result is an integer, by analogy with
  #     [`Float#div`](https://docs.ruby-lang.org/en/2.6.0/Numeric.html#method-i-div);
  #     see also
  #     [`BigDecimal#divmod`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#method-i-divmod).
  #
  #
  ...
  # [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html) number,
  # as an [`Integer`](https://docs.ruby-lang.org/en/2.6.0/Integer.html).
  #
  ...
  # Returns an [`Array`](https://docs.ruby-lang.org/en/2.6.0/Array.html) of two
  # [`Integer`](https://docs.ruby-lang.org/en/2.6.0/Integer.html) values.
  #
  ...
  # [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html), as
  # follows:
  #
  # [`BigDecimal::SIGN_NaN`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#SIGN_NaN)
  # :   value is Not a Number
  # [`BigDecimal::SIGN_POSITIVE_ZERO`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#SIGN_POSITIVE_ZERO)
  # :   value is +0
  # [`BigDecimal::SIGN_NEGATIVE_ZERO`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#SIGN_NEGATIVE_ZERO)
  # :   value is -0
  # [`BigDecimal::SIGN_POSITIVE_INFINITE`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#SIGN_POSITIVE_INFINITE)
  # :   value is +Infinity
  # [`BigDecimal::SIGN_NEGATIVE_INFINITE`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#SIGN_NEGATIVE_INFINITE)
  # :   value is -Infinity
  # [`BigDecimal::SIGN_POSITIVE_FINITE`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#SIGN_POSITIVE_FINITE)
  # :   value is positive
  # [`BigDecimal::SIGN_NEGATIVE_FINITE`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#SIGN_NEGATIVE_FINITE)
  # :   value is negative
  sig {returns(Integer)}
  def sign(); end

  # Splits a [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html)
  # number into four parts, returned as an array of values.
  #
  # The first value represents the sign of the
  # [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html), and is
  # -1 or 1, or 0 if the
  # [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html) is Not a
  # Number.
  #
  # The second value is a string representing the significant digits of the
  # [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html), with no
  # leading zeros.
  #
  ...
  # [`Integer`](https://docs.ruby-lang.org/en/2.6.0/Integer.html) exponent.
  #
  # If the [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html)
  ...
  # [`BigDecimal`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html) to a
  # float as follows:
  #
  # ```ruby
  ...
  #
  # (Note that the
  # [`to_f`](https://docs.ruby-lang.org/en/2.6.0/BigDecimal.html#method-i-to_f)
  ...
  # [`Float`](https://docs.ruby-lang.org/en/2.6.0/Float.html) arithmetic apply.
  sig {returns(Float)}
  def to_f(); end
