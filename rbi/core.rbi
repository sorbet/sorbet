...
::ARGF = T.cast(nil, Object)
::ARGV = T.cast(nil, Array)
::CROSS_COMPILING = T.cast(nil, NilClass)
::ENV = T.cast(nil, Object)
::FALSE = T.cast(nil, FalseClass)
::NIL = T.cast(nil, NilClass)
::RUBYGEMS_ACTIVATION_MONITOR = T.cast(nil, Monitor)
::RUBY_COPYRIGHT = T.cast(nil, String)
::RUBY_DESCRIPTION = T.cast(nil, String)
::RUBY_ENGINE = T.cast(nil, String)
::RUBY_ENGINE_VERSION = T.cast(nil, String)
::RUBY_PATCHLEVEL = T.cast(nil, Integer)
::RUBY_PLATFORM = T.cast(nil, String)
::RUBY_RELEASE_DATE = T.cast(nil, String)
::RUBY_REVISION = T.cast(nil, Integer)
::RUBY_VERSION = T.cast(nil, String)
::STDERR = T.cast(nil, IO)
::STDIN = T.cast(nil, IO)
::STDOUT = T.cast(nil, IO)
::TOPLEVEL_BINDING = T.cast(nil, Binding)
::TRUE = T.cast(nil, TrueClass)
