...
::ARGF = T.let(nil, Object)
::ARGV = T.let(nil, Array)
::CROSS_COMPILING = T.let(nil, NilClass)
::FALSE = T.let(nil, FalseClass)
::NIL = T.let(nil, NilClass)
::RUBYGEMS_ACTIVATION_MONITOR = T.let(nil, Monitor)
::RUBY_COPYRIGHT = T.let(nil, String)
::RUBY_DESCRIPTION = T.let(nil, String)
::RUBY_ENGINE = T.let(nil, String)
::RUBY_ENGINE_VERSION = T.let(nil, String)
::RUBY_PATCHLEVEL = T.let(nil, Integer)
::RUBY_PLATFORM = T.let(nil, String)
::RUBY_RELEASE_DATE = T.let(nil, String)
::RUBY_REVISION = T.let(nil, Integer)
::RUBY_VERSION = T.let(nil, String)
::STDERR = T.let(nil, IO)
::STDIN = T.let(nil, IO)
::STDOUT = T.let(nil, IO)
::TOPLEVEL_BINDING = T.let(nil, Binding)
::TRUE = T.let(nil, TrueClass)
Benchmark::BENCHMARK_VERSION = T.let(nil, String)
Benchmark::CAPTION = T.let(nil, String)
Benchmark::FORMAT = T.let(nil, String)
Benchmark::Tms::CAPTION = T.let(nil, String)
Benchmark::Tms::FORMAT = T.let(nil, String)
BigDecimal::BASE = T.let(nil, Integer)
BigDecimal::EXCEPTION_ALL = T.let(nil, Integer)
BigDecimal::EXCEPTION_INFINITY = T.let(nil, Integer)
BigDecimal::EXCEPTION_OVERFLOW = T.let(nil, Integer)
BigDecimal::EXCEPTION_UNDERFLOW = T.let(nil, Integer)
BigDecimal::EXCEPTION_ZERODIVIDE = T.let(nil, Integer)
BigDecimal::INFINITY = T.let(nil, BigDecimal)
BigDecimal::NAN = T.let(nil, BigDecimal)
BigDecimal::ROUND_CEILING = T.let(nil, Integer)
BigDecimal::ROUND_DOWN = T.let(nil, Integer)
BigDecimal::ROUND_FLOOR = T.let(nil, Integer)
BigDecimal::ROUND_HALF_DOWN = T.let(nil, Integer)
BigDecimal::ROUND_HALF_EVEN = T.let(nil, Integer)
BigDecimal::ROUND_HALF_UP = T.let(nil, Integer)
BigDecimal::ROUND_MODE = T.let(nil, Integer)
BigDecimal::ROUND_UP = T.let(nil, Integer)
BigDecimal::SIGN_NEGATIVE_FINITE = T.let(nil, Integer)
BigDecimal::SIGN_NEGATIVE_INFINITE = T.let(nil, Integer)
BigDecimal::SIGN_NEGATIVE_ZERO = T.let(nil, Integer)
BigDecimal::SIGN_POSITIVE_FINITE = T.let(nil, Integer)
BigDecimal::SIGN_POSITIVE_INFINITE = T.let(nil, Integer)
BigDecimal::SIGN_POSITIVE_ZERO = T.let(nil, Integer)
CSV::DEFAULT_OPTIONS = T.let(nil, Hash)
CSV::VERSION = T.let(nil, String)
Complex::I = T.let(nil, Complex)
Date::ABBR_DAYNAMES = T.let(nil, Array)
Date::ABBR_MONTHNAMES = T.let(nil, Array)
Date::DAYNAMES = T.let(nil, Array)
Date::ENGLAND = T.let(nil, Integer)
Date::GREGORIAN = T.let(nil, Float)
Date::ITALY = T.let(nil, Integer)
Date::JULIAN = T.let(nil, Float)
Date::MONTHNAMES = T.let(nil, Array)
DateTime::ABBR_DAYNAMES = T.let(nil, Array)
DateTime::ABBR_MONTHNAMES = T.let(nil, Array)
DateTime::DAYNAMES = T.let(nil, Array)
DateTime::ENGLAND = T.let(nil, Integer)
DateTime::GREGORIAN = T.let(nil, Float)
DateTime::ITALY = T.let(nil, Integer)
DateTime::JULIAN = T.let(nil, Float)
DateTime::MONTHNAMES = T.let(nil, Array)
DidYouMean::ClassNameChecker::ClassName::RUBYGEMS_ACTIVATION_MONITOR = T.let(nil, Monitor)
DidYouMean::IGNORED_CALLERS = T.let(nil, Array)
DidYouMean::JaroWinkler::THRESHOLD = T.let(nil, Float)
DidYouMean::JaroWinkler::WEIGHT = T.let(nil, Float)
DidYouMean::MethodNameChecker::NAMES_TO_EXCLUDE = T.let(nil, Hash)
DidYouMean::SPELL_CHECKERS = T.let(nil, Hash)
DidYouMean::VERSION = T.let(nil, String)
DidYouMean::VariableNameChecker::NAMES_TO_EXCLUDE = T.let(nil, Hash)
Encoding::ANSI_X3_4_1968 = T.let(nil, Encoding)
Encoding::ASCII = T.let(nil, Encoding)
Encoding::ASCII_8BIT = T.let(nil, Encoding)
Encoding::BIG5 = T.let(nil, Encoding)
Encoding::BIG5_HKSCS = T.let(nil, Encoding)
Encoding::BIG5_HKSCS_2008 = T.let(nil, Encoding)
Encoding::BIG5_UAO = T.let(nil, Encoding)
Encoding::BINARY = T.let(nil, Encoding)
Encoding::CP1250 = T.let(nil, Encoding)
Encoding::CP1251 = T.let(nil, Encoding)
Encoding::CP1252 = T.let(nil, Encoding)
Encoding::CP1253 = T.let(nil, Encoding)
Encoding::CP1254 = T.let(nil, Encoding)
Encoding::CP1255 = T.let(nil, Encoding)
Encoding::CP1256 = T.let(nil, Encoding)
Encoding::CP1257 = T.let(nil, Encoding)
Encoding::CP1258 = T.let(nil, Encoding)
Encoding::CP437 = T.let(nil, Encoding)
Encoding::CP50220 = T.let(nil, Encoding)
Encoding::CP50221 = T.let(nil, Encoding)
Encoding::CP51932 = T.let(nil, Encoding)
Encoding::CP65000 = T.let(nil, Encoding)
Encoding::CP65001 = T.let(nil, Encoding)
Encoding::CP737 = T.let(nil, Encoding)
Encoding::CP775 = T.let(nil, Encoding)
Encoding::CP850 = T.let(nil, Encoding)
Encoding::CP852 = T.let(nil, Encoding)
Encoding::CP855 = T.let(nil, Encoding)
Encoding::CP857 = T.let(nil, Encoding)
Encoding::CP860 = T.let(nil, Encoding)
Encoding::CP861 = T.let(nil, Encoding)
Encoding::CP862 = T.let(nil, Encoding)
Encoding::CP863 = T.let(nil, Encoding)
Encoding::CP864 = T.let(nil, Encoding)
Encoding::CP865 = T.let(nil, Encoding)
Encoding::CP866 = T.let(nil, Encoding)
Encoding::CP869 = T.let(nil, Encoding)
Encoding::CP874 = T.let(nil, Encoding)
Encoding::CP878 = T.let(nil, Encoding)
Encoding::CP932 = T.let(nil, Encoding)
Encoding::CP936 = T.let(nil, Encoding)
Encoding::CP949 = T.let(nil, Encoding)
Encoding::CP950 = T.let(nil, Encoding)
Encoding::CP951 = T.let(nil, Encoding)
Encoding::CSWINDOWS31J = T.let(nil, Encoding)
Encoding::Converter::AFTER_OUTPUT = T.let(nil, Integer)
Encoding::Converter::CRLF_NEWLINE_DECORATOR = T.let(nil, Integer)
Encoding::Converter::CR_NEWLINE_DECORATOR = T.let(nil, Integer)
Encoding::Converter::INVALID_MASK = T.let(nil, Integer)
Encoding::Converter::INVALID_REPLACE = T.let(nil, Integer)
Encoding::Converter::PARTIAL_INPUT = T.let(nil, Integer)
Encoding::Converter::UNDEF_HEX_CHARREF = T.let(nil, Integer)
Encoding::Converter::UNDEF_MASK = T.let(nil, Integer)
Encoding::Converter::UNDEF_REPLACE = T.let(nil, Integer)
Encoding::Converter::UNIVERSAL_NEWLINE_DECORATOR = T.let(nil, Integer)
Encoding::Converter::XML_ATTR_CONTENT_DECORATOR = T.let(nil, Integer)
Encoding::Converter::XML_ATTR_QUOTE_DECORATOR = T.let(nil, Integer)
Encoding::Converter::XML_TEXT_DECORATOR = T.let(nil, Integer)
Encoding::EBCDIC_CP_US = T.let(nil, Encoding)
Encoding::EMACS_MULE = T.let(nil, Encoding)
Encoding::EUCCN = T.let(nil, Encoding)
Encoding::EUCJP = T.let(nil, Encoding)
Encoding::EUCJP_MS = T.let(nil, Encoding)
Encoding::EUCKR = T.let(nil, Encoding)
Encoding::EUCTW = T.let(nil, Encoding)
Encoding::EUC_CN = T.let(nil, Encoding)
Encoding::EUC_JISX0213 = T.let(nil, Encoding)
Encoding::EUC_JIS_2004 = T.let(nil, Encoding)
Encoding::EUC_JP = T.let(nil, Encoding)
Encoding::EUC_JP_MS = T.let(nil, Encoding)
Encoding::EUC_KR = T.let(nil, Encoding)
Encoding::EUC_TW = T.let(nil, Encoding)
Encoding::GB12345 = T.let(nil, Encoding)
Encoding::GB18030 = T.let(nil, Encoding)
Encoding::GB1988 = T.let(nil, Encoding)
Encoding::GB2312 = T.let(nil, Encoding)
Encoding::GBK = T.let(nil, Encoding)
Encoding::IBM037 = T.let(nil, Encoding)
Encoding::IBM437 = T.let(nil, Encoding)
Encoding::IBM737 = T.let(nil, Encoding)
Encoding::IBM775 = T.let(nil, Encoding)
Encoding::IBM850 = T.let(nil, Encoding)
Encoding::IBM852 = T.let(nil, Encoding)
Encoding::IBM855 = T.let(nil, Encoding)
Encoding::IBM857 = T.let(nil, Encoding)
Encoding::IBM860 = T.let(nil, Encoding)
Encoding::IBM861 = T.let(nil, Encoding)
Encoding::IBM862 = T.let(nil, Encoding)
Encoding::IBM863 = T.let(nil, Encoding)
Encoding::IBM864 = T.let(nil, Encoding)
Encoding::IBM865 = T.let(nil, Encoding)
Encoding::IBM866 = T.let(nil, Encoding)
Encoding::IBM869 = T.let(nil, Encoding)
Encoding::ISO2022_JP = T.let(nil, Encoding)
Encoding::ISO2022_JP2 = T.let(nil, Encoding)
Encoding::ISO8859_1 = T.let(nil, Encoding)
Encoding::ISO8859_10 = T.let(nil, Encoding)
Encoding::ISO8859_11 = T.let(nil, Encoding)
Encoding::ISO8859_13 = T.let(nil, Encoding)
Encoding::ISO8859_14 = T.let(nil, Encoding)
Encoding::ISO8859_15 = T.let(nil, Encoding)
Encoding::ISO8859_16 = T.let(nil, Encoding)
Encoding::ISO8859_2 = T.let(nil, Encoding)
Encoding::ISO8859_3 = T.let(nil, Encoding)
Encoding::ISO8859_4 = T.let(nil, Encoding)
Encoding::ISO8859_5 = T.let(nil, Encoding)
Encoding::ISO8859_6 = T.let(nil, Encoding)
Encoding::ISO8859_7 = T.let(nil, Encoding)
Encoding::ISO8859_8 = T.let(nil, Encoding)
Encoding::ISO8859_9 = T.let(nil, Encoding)
Encoding::ISO_2022_JP = T.let(nil, Encoding)
Encoding::ISO_2022_JP_2 = T.let(nil, Encoding)
Encoding::ISO_2022_JP_KDDI = T.let(nil, Encoding)
Encoding::ISO_8859_1 = T.let(nil, Encoding)
Encoding::ISO_8859_10 = T.let(nil, Encoding)
Encoding::ISO_8859_11 = T.let(nil, Encoding)
Encoding::ISO_8859_13 = T.let(nil, Encoding)
Encoding::ISO_8859_14 = T.let(nil, Encoding)
Encoding::ISO_8859_15 = T.let(nil, Encoding)
Encoding::ISO_8859_16 = T.let(nil, Encoding)
Encoding::ISO_8859_2 = T.let(nil, Encoding)
Encoding::ISO_8859_3 = T.let(nil, Encoding)
Encoding::ISO_8859_4 = T.let(nil, Encoding)
Encoding::ISO_8859_5 = T.let(nil, Encoding)
Encoding::ISO_8859_6 = T.let(nil, Encoding)
Encoding::ISO_8859_7 = T.let(nil, Encoding)
Encoding::ISO_8859_8 = T.let(nil, Encoding)
Encoding::ISO_8859_9 = T.let(nil, Encoding)
Encoding::KOI8_R = T.let(nil, Encoding)
Encoding::KOI8_U = T.let(nil, Encoding)
Encoding::MACCENTEURO = T.let(nil, Encoding)
Encoding::MACCROATIAN = T.let(nil, Encoding)
Encoding::MACCYRILLIC = T.let(nil, Encoding)
Encoding::MACGREEK = T.let(nil, Encoding)
Encoding::MACICELAND = T.let(nil, Encoding)
Encoding::MACJAPAN = T.let(nil, Encoding)
Encoding::MACJAPANESE = T.let(nil, Encoding)
Encoding::MACROMAN = T.let(nil, Encoding)
Encoding::MACROMANIA = T.let(nil, Encoding)
Encoding::MACTHAI = T.let(nil, Encoding)
Encoding::MACTURKISH = T.let(nil, Encoding)
Encoding::MACUKRAINE = T.let(nil, Encoding)
Encoding::PCK = T.let(nil, Encoding)
Encoding::SHIFT_JIS = T.let(nil, Encoding)
Encoding::SJIS = T.let(nil, Encoding)
Encoding::SJIS_DOCOMO = T.let(nil, Encoding)
Encoding::SJIS_KDDI = T.let(nil, Encoding)
Encoding::SJIS_SOFTBANK = T.let(nil, Encoding)
Encoding::STATELESS_ISO_2022_JP = T.let(nil, Encoding)
Encoding::STATELESS_ISO_2022_JP_KDDI = T.let(nil, Encoding)
Encoding::TIS_620 = T.let(nil, Encoding)
Encoding::UCS_2BE = T.let(nil, Encoding)
Encoding::UCS_4BE = T.let(nil, Encoding)
Encoding::UCS_4LE = T.let(nil, Encoding)
Encoding::US_ASCII = T.let(nil, Encoding)
Encoding::UTF8_DOCOMO = T.let(nil, Encoding)
Encoding::UTF8_KDDI = T.let(nil, Encoding)
Encoding::UTF8_MAC = T.let(nil, Encoding)
Encoding::UTF8_SOFTBANK = T.let(nil, Encoding)
Encoding::UTF_16 = T.let(nil, Encoding)
Encoding::UTF_16BE = T.let(nil, Encoding)
Encoding::UTF_16LE = T.let(nil, Encoding)
Encoding::UTF_32 = T.let(nil, Encoding)
Encoding::UTF_32BE = T.let(nil, Encoding)
Encoding::UTF_32LE = T.let(nil, Encoding)
Encoding::UTF_7 = T.let(nil, Encoding)
Encoding::UTF_8 = T.let(nil, Encoding)
Encoding::UTF_8_HFS = T.let(nil, Encoding)
Encoding::UTF_8_MAC = T.let(nil, Encoding)
Encoding::WINDOWS_1250 = T.let(nil, Encoding)
Encoding::WINDOWS_1251 = T.let(nil, Encoding)
Encoding::WINDOWS_1252 = T.let(nil, Encoding)
Encoding::WINDOWS_1253 = T.let(nil, Encoding)
Encoding::WINDOWS_1254 = T.let(nil, Encoding)
Encoding::WINDOWS_1255 = T.let(nil, Encoding)
Encoding::WINDOWS_1256 = T.let(nil, Encoding)
Encoding::WINDOWS_1257 = T.let(nil, Encoding)
Encoding::WINDOWS_1258 = T.let(nil, Encoding)
Encoding::WINDOWS_31J = T.let(nil, Encoding)
Encoding::WINDOWS_874 = T.let(nil, Encoding)
File::ALT_SEPARATOR = T.let(nil, NilClass)
File::APPEND = T.let(nil, Integer)
File::BINARY = T.let(nil, Integer)
File::CREAT = T.let(nil, Integer)
File::Constants::APPEND = T.let(nil, Integer)
File::Constants::BINARY = T.let(nil, Integer)
File::Constants::CREAT = T.let(nil, Integer)
File::Constants::DIRECT = T.let(nil, Integer)
File::Constants::DSYNC = T.let(nil, Integer)
File::Constants::EXCL = T.let(nil, Integer)
File::Constants::FNM_CASEFOLD = T.let(nil, Integer)
File::Constants::FNM_DOTMATCH = T.let(nil, Integer)
File::Constants::FNM_EXTGLOB = T.let(nil, Integer)
File::Constants::FNM_NOESCAPE = T.let(nil, Integer)
File::Constants::FNM_PATHNAME = T.let(nil, Integer)
File::Constants::FNM_SHORTNAME = T.let(nil, Integer)
File::Constants::FNM_SYSCASE = T.let(nil, Integer)
File::Constants::LOCK_EX = T.let(nil, Integer)
File::Constants::LOCK_NB = T.let(nil, Integer)
File::Constants::LOCK_SH = T.let(nil, Integer)
File::Constants::LOCK_UN = T.let(nil, Integer)
File::Constants::NOATIME = T.let(nil, Integer)
File::Constants::NOCTTY = T.let(nil, Integer)
File::Constants::NOFOLLOW = T.let(nil, Integer)
File::Constants::NONBLOCK = T.let(nil, Integer)
File::Constants::NULL = T.let(nil, String)
File::Constants::RDONLY = T.let(nil, Integer)
File::Constants::RDWR = T.let(nil, Integer)
File::Constants::RSYNC = T.let(nil, Integer)
File::Constants::SHARE_DELETE = T.let(nil, Integer)
File::Constants::SYNC = T.let(nil, Integer)
File::Constants::TMPFILE = T.let(nil, Integer)
File::Constants::TRUNC = T.let(nil, Integer)
File::Constants::WRONLY = T.let(nil, Integer)
File::DIRECT = T.let(nil, Integer)
File::DSYNC = T.let(nil, Integer)
File::EXCL = T.let(nil, Integer)
File::FNM_CASEFOLD = T.let(nil, Integer)
File::FNM_DOTMATCH = T.let(nil, Integer)
File::FNM_EXTGLOB = T.let(nil, Integer)
File::FNM_NOESCAPE = T.let(nil, Integer)
File::FNM_PATHNAME = T.let(nil, Integer)
File::FNM_SHORTNAME = T.let(nil, Integer)
File::FNM_SYSCASE = T.let(nil, Integer)
File::LOCK_EX = T.let(nil, Integer)
File::LOCK_NB = T.let(nil, Integer)
File::LOCK_SH = T.let(nil, Integer)
File::LOCK_UN = T.let(nil, Integer)
File::NOATIME = T.let(nil, Integer)
File::NOCTTY = T.let(nil, Integer)
File::NOFOLLOW = T.let(nil, Integer)
File::NONBLOCK = T.let(nil, Integer)
File::NULL = T.let(nil, String)
File::PATH_SEPARATOR = T.let(nil, String)
File::RDONLY = T.let(nil, Integer)
File::RDWR = T.let(nil, Integer)
File::RSYNC = T.let(nil, Integer)
File::SEEK_CUR = T.let(nil, Integer)
File::SEEK_DATA = T.let(nil, Integer)
File::SEEK_END = T.let(nil, Integer)
File::SEEK_HOLE = T.let(nil, Integer)
File::SEEK_SET = T.let(nil, Integer)
File::SEPARATOR = T.let(nil, String)
File::SHARE_DELETE = T.let(nil, Integer)
File::SYNC = T.let(nil, Integer)
File::TMPFILE = T.let(nil, Integer)
File::TRUNC = T.let(nil, Integer)
File::WRONLY = T.let(nil, Integer)
Float::DIG = T.let(nil, Integer)
Float::EPSILON = T.let(nil, Float)
Float::INFINITY = T.let(nil, Float)
Float::MANT_DIG = T.let(nil, Integer)
Float::MAX = T.let(nil, Float)
Float::MAX_10_EXP = T.let(nil, Integer)
Float::MAX_EXP = T.let(nil, Integer)
Float::MIN = T.let(nil, Float)
Float::MIN_10_EXP = T.let(nil, Integer)
Float::MIN_EXP = T.let(nil, Integer)
Float::NAN = T.let(nil, Float)
Float::RADIX = T.let(nil, Integer)
Float::ROUNDS = T.let(nil, Integer)
Forwardable::FILTER_EXCEPTION = T.let(nil, String)
Forwardable::FORWARDABLE_VERSION = T.let(nil, String)
GC::INTERNAL_CONSTANTS = T.let(nil, Hash)
GC::OPTS = T.let(nil, Array)
Gem::DEFAULT_HOST = T.let(nil, String)
Gem::Dependency::TYPES = T.let(nil, Array)
Gem::GEM_DEP_FILES = T.let(nil, Array)
Gem::GEM_PRELUDE_SUCKAGE = T.let(nil, NilClass)
Gem::LOADED_SPECS_MUTEX = T.let(nil, Thread::Mutex)
Gem::MARSHAL_SPEC_DIR = T.let(nil, String)
Gem::Platform::CURRENT = T.let(nil, String)
Gem::Platform::RUBY = T.let(nil, String)
Gem::READ_BINARY_ERRORS = T.let(nil, Array)
Gem::REPOSITORY_DEFAULT_GEM_SUBDIRECTORIES = T.let(nil, Array)
Gem::REPOSITORY_SUBDIRECTORIES = T.let(nil, Array)
Gem::RUBYGEMS_DIR = T.let(nil, String)
Gem::Requirement::OPS = T.let(nil, Hash)
Gem::Requirement::PATTERN = T.let(nil, Regexp)
Gem::Requirement::PATTERN_RAW = T.let(nil, String)
Gem::Requirement::SOURCE_SET_REQUIREMENT = T.let(nil, Object)
Gem::Specification::CURRENT_SPECIFICATION_VERSION = T.let(nil, Integer)
Gem::Specification::EMPTY = T.let(nil, Array)
Gem::Specification::MARSHAL_FIELDS = T.let(nil, Hash)
Gem::Specification::NONEXISTENT_SPECIFICATION_VERSION = T.let(nil, Integer)
Gem::Specification::NOT_FOUND = T.let(nil, Object)
Gem::Specification::SPECIFICATION_VERSION_HISTORY = T.let(nil, Hash)
Gem::Specification::TODAY = T.let(nil, Time)
Gem::Specification::VALID_NAME_PATTERN = T.let(nil, Regexp)
Gem::StubSpecification::OPEN_MODE = T.let(nil, String)
Gem::StubSpecification::PREFIX = T.let(nil, String)
Gem::StubSpecification::StubLine::NO_EXTENSIONS = T.let(nil, Array)
Gem::StubSpecification::StubLine::REQUIRE_PATHS = T.let(nil, Hash)
Gem::StubSpecification::StubLine::REQUIRE_PATH_LIST = T.let(nil, Hash)
Gem::VERSION = T.let(nil, String)
Gem::Version::ANCHORED_VERSION_PATTERN = T.let(nil, Regexp)
Gem::Version::VERSION_PATTERN = T.let(nil, String)
Gem::WIN_PATTERNS = T.let(nil, Array)
Gem::WRITE_BINARY_ERRORS = T.let(nil, Array)
IO::APPEND = T.let(nil, Integer)
IO::BINARY = T.let(nil, Integer)
IO::CREAT = T.let(nil, Integer)
IO::DIRECT = T.let(nil, Integer)
IO::DSYNC = T.let(nil, Integer)
IO::EXCL = T.let(nil, Integer)
IO::FNM_CASEFOLD = T.let(nil, Integer)
IO::FNM_DOTMATCH = T.let(nil, Integer)
IO::FNM_EXTGLOB = T.let(nil, Integer)
IO::FNM_NOESCAPE = T.let(nil, Integer)
IO::FNM_PATHNAME = T.let(nil, Integer)
IO::FNM_SHORTNAME = T.let(nil, Integer)
IO::FNM_SYSCASE = T.let(nil, Integer)
IO::LOCK_EX = T.let(nil, Integer)
IO::LOCK_NB = T.let(nil, Integer)
IO::LOCK_SH = T.let(nil, Integer)
IO::LOCK_UN = T.let(nil, Integer)
IO::NOATIME = T.let(nil, Integer)
IO::NOCTTY = T.let(nil, Integer)
IO::NOFOLLOW = T.let(nil, Integer)
IO::NONBLOCK = T.let(nil, Integer)
IO::NULL = T.let(nil, String)
IO::RDONLY = T.let(nil, Integer)
IO::RDWR = T.let(nil, Integer)
IO::RSYNC = T.let(nil, Integer)
IO::SEEK_CUR = T.let(nil, Integer)
IO::SEEK_DATA = T.let(nil, Integer)
IO::SEEK_END = T.let(nil, Integer)
IO::SEEK_HOLE = T.let(nil, Integer)
IO::SEEK_SET = T.let(nil, Integer)
IO::SHARE_DELETE = T.let(nil, Integer)
IO::SYNC = T.let(nil, Integer)
IO::TMPFILE = T.let(nil, Integer)
IO::TRUNC = T.let(nil, Integer)
IO::WRONLY = T.let(nil, Integer)
Kernel::RUBYGEMS_ACTIVATION_MONITOR = T.let(nil, Monitor)
Marshal::MAJOR_VERSION = T.let(nil, Integer)
Marshal::MINOR_VERSION = T.let(nil, Integer)
Math::E = T.let(nil, Float)
Math::PI = T.let(nil, Float)
Module::ARGF = T.let(nil, Object)
Module::ARGV = T.let(nil, Array)
Module::CROSS_COMPILING = T.let(nil, NilClass)
Module::FALSE = T.let(nil, FalseClass)
Module::NIL = T.let(nil, NilClass)
Module::RUBY_COPYRIGHT = T.let(nil, String)
Module::RUBY_DESCRIPTION = T.let(nil, String)
Module::RUBY_ENGINE = T.let(nil, String)
Module::RUBY_ENGINE_VERSION = T.let(nil, String)
Module::RUBY_PATCHLEVEL = T.let(nil, Integer)
Module::RUBY_PLATFORM = T.let(nil, String)
Module::RUBY_RELEASE_DATE = T.let(nil, String)
Module::RUBY_REVISION = T.let(nil, Integer)
Module::RUBY_VERSION = T.let(nil, String)
Module::STDERR = T.let(nil, IO)
Module::STDIN = T.let(nil, IO)
Module::STDOUT = T.let(nil, IO)
Module::TOPLEVEL_BINDING = T.let(nil, Binding)
Module::TRUE = T.let(nil, TrueClass)
Process::CLOCK_BOOTTIME = T.let(nil, Integer)
Process::CLOCK_BOOTTIME_ALARM = T.let(nil, Integer)
Process::CLOCK_MONOTONIC = T.let(nil, Integer)
Process::CLOCK_MONOTONIC_COARSE = T.let(nil, Integer)
Process::CLOCK_MONOTONIC_RAW = T.let(nil, Integer)
Process::CLOCK_PROCESS_CPUTIME_ID = T.let(nil, Integer)
Process::CLOCK_REALTIME = T.let(nil, Integer)
Process::CLOCK_REALTIME_ALARM = T.let(nil, Integer)
Process::CLOCK_REALTIME_COARSE = T.let(nil, Integer)
Process::CLOCK_THREAD_CPUTIME_ID = T.let(nil, Integer)
Process::PRIO_PGRP = T.let(nil, Integer)
Process::PRIO_PROCESS = T.let(nil, Integer)
Process::PRIO_USER = T.let(nil, Integer)
Process::RLIMIT_AS = T.let(nil, Integer)
Process::RLIMIT_CORE = T.let(nil, Integer)
Process::RLIMIT_CPU = T.let(nil, Integer)
Process::RLIMIT_DATA = T.let(nil, Integer)
Process::RLIMIT_FSIZE = T.let(nil, Integer)
Process::RLIMIT_MEMLOCK = T.let(nil, Integer)
Process::RLIMIT_MSGQUEUE = T.let(nil, Integer)
Process::RLIMIT_NICE = T.let(nil, Integer)
Process::RLIMIT_NOFILE = T.let(nil, Integer)
Process::RLIMIT_NPROC = T.let(nil, Integer)
Process::RLIMIT_RSS = T.let(nil, Integer)
Process::RLIMIT_RTPRIO = T.let(nil, Integer)
Process::RLIMIT_RTTIME = T.let(nil, Integer)
Process::RLIMIT_SIGPENDING = T.let(nil, Integer)
Process::RLIMIT_STACK = T.let(nil, Integer)
Process::RLIM_INFINITY = T.let(nil, Integer)
Process::RLIM_SAVED_CUR = T.let(nil, Integer)
Process::RLIM_SAVED_MAX = T.let(nil, Integer)
Process::WNOHANG = T.let(nil, Integer)
Process::WUNTRACED = T.let(nil, Integer)
Random::DEFAULT = T.let(nil, Random)
RbConfig::CONFIG = T.let(nil, Hash)
RbConfig::DESTDIR = T.let(nil, String)
RbConfig::MAKEFILE_CONFIG = T.let(nil, Hash)
RbConfig::TOPDIR = T.let(nil, String)
Regexp::EXTENDED = T.let(nil, Integer)
Regexp::FIXEDENCODING = T.let(nil, Integer)
Regexp::IGNORECASE = T.let(nil, Integer)
Regexp::MULTILINE = T.let(nil, Integer)
Regexp::NOENCODING = T.let(nil, Integer)
RubyVM::DEFAULT_PARAMS = T.let(nil, Hash)
RubyVM::INSTRUCTION_NAMES = T.let(nil, Array)
RubyVM::OPTS = T.let(nil, Array)
Time::RFC2822_DAY_NAME = T.let(nil, Array)
Time::RFC2822_MONTH_NAME = T.let(nil, Array)
URI::ABS_PATH = T.let(nil, Regexp)
URI::ABS_URI = T.let(nil, Regexp)
URI::ABS_URI_REF = T.let(nil, Regexp)
URI::DEFAULT_PARSER = T.let(nil, URI::RFC2396_Parser)
URI::ESCAPED = T.let(nil, Regexp)
URI::FRAGMENT = T.let(nil, Regexp)
URI::FTP::ABS_PATH = T.let(nil, Regexp)
URI::FTP::ABS_URI = T.let(nil, Regexp)
URI::FTP::ABS_URI_REF = T.let(nil, Regexp)
URI::FTP::COMPONENT = T.let(nil, Array)
URI::FTP::DEFAULT_PARSER = T.let(nil, URI::RFC2396_Parser)
URI::FTP::DEFAULT_PORT = T.let(nil, Integer)
URI::FTP::ESCAPED = T.let(nil, Regexp)
URI::FTP::FRAGMENT = T.let(nil, Regexp)
URI::FTP::HOST = T.let(nil, Regexp)
URI::FTP::HTML5ASCIIINCOMPAT = T.let(nil, String)
URI::FTP::OPAQUE = T.let(nil, Regexp)
URI::FTP::PORT = T.let(nil, Regexp)
URI::FTP::QUERY = T.let(nil, Regexp)
URI::FTP::REGISTRY = T.let(nil, Regexp)
URI::FTP::REL_PATH = T.let(nil, Regexp)
URI::FTP::REL_URI = T.let(nil, Regexp)
URI::FTP::REL_URI_REF = T.let(nil, Regexp)
URI::FTP::RFC3986_PARSER = T.let(nil, URI::RFC3986_Parser)
URI::FTP::SCHEME = T.let(nil, Regexp)
URI::FTP::TBLDECWWWCOMP_ = T.let(nil, Hash)
URI::FTP::TBLENCWWWCOMP_ = T.let(nil, Hash)
URI::FTP::TYPECODE = T.let(nil, Array)
URI::FTP::TYPECODE_PREFIX = T.let(nil, String)
URI::FTP::UNSAFE = T.let(nil, Regexp)
URI::FTP::URI_REF = T.let(nil, Regexp)
URI::FTP::USERINFO = T.let(nil, Regexp)
URI::FTP::USE_REGISTRY = T.let(nil, FalseClass)
URI::FTP::VERSION = T.let(nil, String)
URI::FTP::VERSION_CODE = T.let(nil, String)
URI::FTP::WEB_ENCODINGS_ = T.let(nil, Hash)
URI::Generic::ABS_PATH = T.let(nil, Regexp)
URI::Generic::ABS_URI = T.let(nil, Regexp)
URI::Generic::ABS_URI_REF = T.let(nil, Regexp)
URI::Generic::COMPONENT = T.let(nil, Array)
URI::Generic::DEFAULT_PARSER = T.let(nil, URI::RFC2396_Parser)
URI::Generic::DEFAULT_PORT = T.let(nil, NilClass)
URI::Generic::ESCAPED = T.let(nil, Regexp)
URI::Generic::FRAGMENT = T.let(nil, Regexp)
URI::Generic::HOST = T.let(nil, Regexp)
URI::Generic::HTML5ASCIIINCOMPAT = T.let(nil, String)
URI::Generic::OPAQUE = T.let(nil, Regexp)
URI::Generic::PORT = T.let(nil, Regexp)
URI::Generic::QUERY = T.let(nil, Regexp)
URI::Generic::REGISTRY = T.let(nil, Regexp)
URI::Generic::REL_PATH = T.let(nil, Regexp)
URI::Generic::REL_URI = T.let(nil, Regexp)
URI::Generic::REL_URI_REF = T.let(nil, Regexp)
URI::Generic::RFC3986_PARSER = T.let(nil, URI::RFC3986_Parser)
URI::Generic::SCHEME = T.let(nil, Regexp)
URI::Generic::TBLDECWWWCOMP_ = T.let(nil, Hash)
URI::Generic::TBLENCWWWCOMP_ = T.let(nil, Hash)
URI::Generic::UNSAFE = T.let(nil, Regexp)
URI::Generic::URI_REF = T.let(nil, Regexp)
URI::Generic::USERINFO = T.let(nil, Regexp)
URI::Generic::USE_REGISTRY = T.let(nil, FalseClass)
URI::Generic::VERSION = T.let(nil, String)
URI::Generic::VERSION_CODE = T.let(nil, String)
URI::Generic::WEB_ENCODINGS_ = T.let(nil, Hash)
URI::HOST = T.let(nil, Regexp)
URI::HTML5ASCIIINCOMPAT = T.let(nil, String)
URI::HTTP::ABS_PATH = T.let(nil, Regexp)
URI::HTTP::ABS_URI = T.let(nil, Regexp)
URI::HTTP::ABS_URI_REF = T.let(nil, Regexp)
URI::HTTP::COMPONENT = T.let(nil, Array)
URI::HTTP::DEFAULT_PARSER = T.let(nil, URI::RFC2396_Parser)
URI::HTTP::DEFAULT_PORT = T.let(nil, Integer)
URI::HTTP::ESCAPED = T.let(nil, Regexp)
URI::HTTP::FRAGMENT = T.let(nil, Regexp)
URI::HTTP::HOST = T.let(nil, Regexp)
URI::HTTP::HTML5ASCIIINCOMPAT = T.let(nil, String)
URI::HTTP::OPAQUE = T.let(nil, Regexp)
URI::HTTP::PORT = T.let(nil, Regexp)
URI::HTTP::QUERY = T.let(nil, Regexp)
URI::HTTP::REGISTRY = T.let(nil, Regexp)
URI::HTTP::REL_PATH = T.let(nil, Regexp)
URI::HTTP::REL_URI = T.let(nil, Regexp)
URI::HTTP::REL_URI_REF = T.let(nil, Regexp)
URI::HTTP::RFC3986_PARSER = T.let(nil, URI::RFC3986_Parser)
URI::HTTP::SCHEME = T.let(nil, Regexp)
URI::HTTP::TBLDECWWWCOMP_ = T.let(nil, Hash)
URI::HTTP::TBLENCWWWCOMP_ = T.let(nil, Hash)
URI::HTTP::UNSAFE = T.let(nil, Regexp)
URI::HTTP::URI_REF = T.let(nil, Regexp)
URI::HTTP::USERINFO = T.let(nil, Regexp)
URI::HTTP::USE_REGISTRY = T.let(nil, FalseClass)
URI::HTTP::VERSION = T.let(nil, String)
URI::HTTP::VERSION_CODE = T.let(nil, String)
URI::HTTP::WEB_ENCODINGS_ = T.let(nil, Hash)
URI::HTTPS::ABS_PATH = T.let(nil, Regexp)
URI::HTTPS::ABS_URI = T.let(nil, Regexp)
URI::HTTPS::ABS_URI_REF = T.let(nil, Regexp)
URI::HTTPS::COMPONENT = T.let(nil, Array)
URI::HTTPS::DEFAULT_PARSER = T.let(nil, URI::RFC2396_Parser)
URI::HTTPS::DEFAULT_PORT = T.let(nil, Integer)
URI::HTTPS::ESCAPED = T.let(nil, Regexp)
URI::HTTPS::FRAGMENT = T.let(nil, Regexp)
URI::HTTPS::HOST = T.let(nil, Regexp)
URI::HTTPS::HTML5ASCIIINCOMPAT = T.let(nil, String)
URI::HTTPS::OPAQUE = T.let(nil, Regexp)
URI::HTTPS::PORT = T.let(nil, Regexp)
URI::HTTPS::QUERY = T.let(nil, Regexp)
URI::HTTPS::REGISTRY = T.let(nil, Regexp)
URI::HTTPS::REL_PATH = T.let(nil, Regexp)
URI::HTTPS::REL_URI = T.let(nil, Regexp)
URI::HTTPS::REL_URI_REF = T.let(nil, Regexp)
URI::HTTPS::RFC3986_PARSER = T.let(nil, URI::RFC3986_Parser)
URI::HTTPS::SCHEME = T.let(nil, Regexp)
URI::HTTPS::TBLDECWWWCOMP_ = T.let(nil, Hash)
URI::HTTPS::TBLENCWWWCOMP_ = T.let(nil, Hash)
URI::HTTPS::UNSAFE = T.let(nil, Regexp)
URI::HTTPS::URI_REF = T.let(nil, Regexp)
URI::HTTPS::USERINFO = T.let(nil, Regexp)
URI::HTTPS::USE_REGISTRY = T.let(nil, FalseClass)
URI::HTTPS::VERSION = T.let(nil, String)
URI::HTTPS::VERSION_CODE = T.let(nil, String)
URI::HTTPS::WEB_ENCODINGS_ = T.let(nil, Hash)
URI::LDAP::ABS_PATH = T.let(nil, Regexp)
URI::LDAP::ABS_URI = T.let(nil, Regexp)
URI::LDAP::ABS_URI_REF = T.let(nil, Regexp)
URI::LDAP::COMPONENT = T.let(nil, Array)
URI::LDAP::DEFAULT_PARSER = T.let(nil, URI::RFC2396_Parser)
URI::LDAP::DEFAULT_PORT = T.let(nil, Integer)
URI::LDAP::ESCAPED = T.let(nil, Regexp)
URI::LDAP::FRAGMENT = T.let(nil, Regexp)
URI::LDAP::HOST = T.let(nil, Regexp)
URI::LDAP::HTML5ASCIIINCOMPAT = T.let(nil, String)
URI::LDAP::OPAQUE = T.let(nil, Regexp)
URI::LDAP::PORT = T.let(nil, Regexp)
URI::LDAP::QUERY = T.let(nil, Regexp)
URI::LDAP::REGISTRY = T.let(nil, Regexp)
URI::LDAP::REL_PATH = T.let(nil, Regexp)
URI::LDAP::REL_URI = T.let(nil, Regexp)
URI::LDAP::REL_URI_REF = T.let(nil, Regexp)
URI::LDAP::RFC3986_PARSER = T.let(nil, URI::RFC3986_Parser)
URI::LDAP::SCHEME = T.let(nil, Regexp)
URI::LDAP::SCOPE = T.let(nil, Array)
URI::LDAP::SCOPE_BASE = T.let(nil, String)
URI::LDAP::SCOPE_ONE = T.let(nil, String)
URI::LDAP::SCOPE_SUB = T.let(nil, String)
URI::LDAP::TBLDECWWWCOMP_ = T.let(nil, Hash)
URI::LDAP::TBLENCWWWCOMP_ = T.let(nil, Hash)
URI::LDAP::UNSAFE = T.let(nil, Regexp)
URI::LDAP::URI_REF = T.let(nil, Regexp)
URI::LDAP::USERINFO = T.let(nil, Regexp)
URI::LDAP::USE_REGISTRY = T.let(nil, FalseClass)
URI::LDAP::VERSION = T.let(nil, String)
URI::LDAP::VERSION_CODE = T.let(nil, String)
URI::LDAP::WEB_ENCODINGS_ = T.let(nil, Hash)
URI::LDAPS::ABS_PATH = T.let(nil, Regexp)
URI::LDAPS::ABS_URI = T.let(nil, Regexp)
URI::LDAPS::ABS_URI_REF = T.let(nil, Regexp)
URI::LDAPS::COMPONENT = T.let(nil, Array)
URI::LDAPS::DEFAULT_PARSER = T.let(nil, URI::RFC2396_Parser)
URI::LDAPS::DEFAULT_PORT = T.let(nil, Integer)
URI::LDAPS::ESCAPED = T.let(nil, Regexp)
URI::LDAPS::FRAGMENT = T.let(nil, Regexp)
URI::LDAPS::HOST = T.let(nil, Regexp)
URI::LDAPS::HTML5ASCIIINCOMPAT = T.let(nil, String)
URI::LDAPS::OPAQUE = T.let(nil, Regexp)
URI::LDAPS::PORT = T.let(nil, Regexp)
URI::LDAPS::QUERY = T.let(nil, Regexp)
URI::LDAPS::REGISTRY = T.let(nil, Regexp)
URI::LDAPS::REL_PATH = T.let(nil, Regexp)
URI::LDAPS::REL_URI = T.let(nil, Regexp)
URI::LDAPS::REL_URI_REF = T.let(nil, Regexp)
URI::LDAPS::RFC3986_PARSER = T.let(nil, URI::RFC3986_Parser)
URI::LDAPS::SCHEME = T.let(nil, Regexp)
URI::LDAPS::SCOPE = T.let(nil, Array)
URI::LDAPS::SCOPE_BASE = T.let(nil, String)
URI::LDAPS::SCOPE_ONE = T.let(nil, String)
URI::LDAPS::SCOPE_SUB = T.let(nil, String)
URI::LDAPS::TBLDECWWWCOMP_ = T.let(nil, Hash)
URI::LDAPS::TBLENCWWWCOMP_ = T.let(nil, Hash)
URI::LDAPS::UNSAFE = T.let(nil, Regexp)
URI::LDAPS::URI_REF = T.let(nil, Regexp)
URI::LDAPS::USERINFO = T.let(nil, Regexp)
URI::LDAPS::USE_REGISTRY = T.let(nil, FalseClass)
URI::LDAPS::VERSION = T.let(nil, String)
URI::LDAPS::VERSION_CODE = T.let(nil, String)
URI::LDAPS::WEB_ENCODINGS_ = T.let(nil, Hash)
URI::MailTo::ABS_PATH = T.let(nil, Regexp)
URI::MailTo::ABS_URI = T.let(nil, Regexp)
URI::MailTo::ABS_URI_REF = T.let(nil, Regexp)
URI::MailTo::COMPONENT = T.let(nil, Array)
URI::MailTo::DEFAULT_PARSER = T.let(nil, URI::RFC2396_Parser)
URI::MailTo::DEFAULT_PORT = T.let(nil, NilClass)
URI::MailTo::EMAIL_REGEXP = T.let(nil, Regexp)
URI::MailTo::ESCAPED = T.let(nil, Regexp)
URI::MailTo::FRAGMENT = T.let(nil, Regexp)
URI::MailTo::HEADER_REGEXP = T.let(nil, Regexp)
URI::MailTo::HOST = T.let(nil, Regexp)
URI::MailTo::HTML5ASCIIINCOMPAT = T.let(nil, String)
URI::MailTo::OPAQUE = T.let(nil, Regexp)
URI::MailTo::PORT = T.let(nil, Regexp)
URI::MailTo::QUERY = T.let(nil, Regexp)
URI::MailTo::REGISTRY = T.let(nil, Regexp)
URI::MailTo::REL_PATH = T.let(nil, Regexp)
URI::MailTo::REL_URI = T.let(nil, Regexp)
URI::MailTo::REL_URI_REF = T.let(nil, Regexp)
URI::MailTo::RFC3986_PARSER = T.let(nil, URI::RFC3986_Parser)
URI::MailTo::SCHEME = T.let(nil, Regexp)
URI::MailTo::TBLDECWWWCOMP_ = T.let(nil, Hash)
URI::MailTo::TBLENCWWWCOMP_ = T.let(nil, Hash)
URI::MailTo::UNSAFE = T.let(nil, Regexp)
URI::MailTo::URI_REF = T.let(nil, Regexp)
URI::MailTo::USERINFO = T.let(nil, Regexp)
URI::MailTo::USE_REGISTRY = T.let(nil, FalseClass)
URI::MailTo::VERSION = T.let(nil, String)
URI::MailTo::VERSION_CODE = T.let(nil, String)
URI::MailTo::WEB_ENCODINGS_ = T.let(nil, Hash)
URI::OPAQUE = T.let(nil, Regexp)
URI::PORT = T.let(nil, Regexp)
URI::QUERY = T.let(nil, Regexp)
URI::REGISTRY = T.let(nil, Regexp)
URI::REL_PATH = T.let(nil, Regexp)
URI::REL_URI = T.let(nil, Regexp)
URI::REL_URI_REF = T.let(nil, Regexp)
URI::RFC2396_REGEXP::PATTERN::ABS_PATH = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::ABS_URI = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::ALNUM = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::ALPHA = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::DOMLABEL = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::ESCAPED = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::FRAGMENT = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::HEX = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::HIER_PART = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::HOST = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::HOSTNAME = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::HOSTPORT = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::IPV4ADDR = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::IPV6ADDR = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::IPV6REF = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::NET_PATH = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::OPAQUE_PART = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::PATH_SEGMENTS = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::PORT = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::QUERY = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::REG_NAME = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::REL_PATH = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::REL_SEGMENT = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::REL_URI = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::RESERVED = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::SCHEME = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::TOPLABEL = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::UNRESERVED = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::URIC = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::URIC_NO_SLASH = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::URI_REF = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::USERINFO = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::X_ABS_URI = T.let(nil, String)
URI::RFC2396_REGEXP::PATTERN::X_REL_URI = T.let(nil, String)
URI::RFC3986_PARSER = T.let(nil, URI::RFC3986_Parser)
URI::RFC3986_Parser::RFC3986_URI = T.let(nil, Regexp)
URI::SCHEME = T.let(nil, Regexp)
URI::TBLDECWWWCOMP_ = T.let(nil, Hash)
URI::TBLENCWWWCOMP_ = T.let(nil, Hash)
URI::UNSAFE = T.let(nil, Regexp)
URI::URI_REF = T.let(nil, Regexp)
URI::USERINFO = T.let(nil, Regexp)
URI::VERSION = T.let(nil, String)
URI::VERSION_CODE = T.let(nil, String)
URI::WEB_ENCODINGS_ = T.let(nil, Hash)
