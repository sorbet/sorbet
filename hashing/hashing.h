...
/**
 * Contains logic pertaining to producing FileHashes for files, which are used in LSP mode to:
...
public:
     ...
     * rewriting the AST to refer to NameRefs in a fresh GlobalState object. The FileHash is stored in the file object.
     *
