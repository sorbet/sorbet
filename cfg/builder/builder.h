...
public:
    ...
    static std::unique_ptr<CFG> buildFor(core::Context ctx, const ast::ClassDef &cd);
...
private:
    ...
    friend std::unique_ptr<CFG> CFGBuilder::buildFor(core::Context ctx, const ast::ClassDef &cd);
