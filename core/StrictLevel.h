...
enum class StrictLevel : uint8_t {
    ...
    // DEPRECATED: This level will be deleted in the future.
    //
    // Identical to `true`.
    //
    // We have not yet deleted this, because autogenerated happens to appear "more strict" in the
    // min_typed_level checks, such that correcting a file from `# typed: autogenerated` to `# typed: true`
    // looks like a regression in `min_typed_level`.
    Autogenerated = 10,
