...
public:
    ...
    void setPackagerOptions(const std::vector<std::string> &extraPackageFilesDirectoryUnderscorePrefixes,
                            ...
                            const std::vector<std::string> &packagerLayers, std::string errorHint, bool genPackages, bool genPackagesStrict);
    ...
    copyForIndex(const std::vector<std::string> &extraPackageFilesDirectoryUnderscorePrefixes,
                 ...
                 const std::vector<std::string> &packagerLayers, std::string errorHint, bool genPackages, bool genPackagesStrict) const;
