...
NameDef names[] = {
    ...
    {"StubModuleSingleton", "StubModuleSingleton", true},
    {"StubField", "StubField", true},
    {"StubTypeMember", "StubTypeMember", true},
    {"StubTypeTemplate", "StubTypeTemplate", true},
    {"StubMethod", "StubMethod", true},
