...
NameDef names[] = {
    ...
    {"bearerTokenVersion", "bearer_token_version"},
    {"bearerTokenConsumedAt", "bearer_token_consumed_at"},
    {"timeForConsumedAt", "DEPRECATED_time_for_consumed_at"},
    {"bearerTokenProp", "bearer_token_prop"},
    {"propPrefixOpt", "prop_prefix"},
