...
void GlobalState::initEmpty() {
    ...
    method = enterMethod(*this, Symbols::PackageSpecSingleton(), Names::project())
                 .typedArg(Names::arg0(), Types::String())
                 .build();
    ENFORCE_NO_TIMER(method == Symbols::PackageSpec_project());

    method = enterMethod(*this, Symbols::PackageSpecSingleton(), Names::service())
                 .typedArg(Names::arg0(), Types::String())
                 .build();
    ENFORCE_NO_TIMER(method == Symbols::PackageSpec_service());
