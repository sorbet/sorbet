...
unique_ptr<GlobalState> GlobalState::copyForIndex(
    ...
    const vector<string> &packagerLayers, string errorHint, bool genPackages, bool deleteUnusedImports) const {
    auto result = make_unique<GlobalState>(this->errorQueue, this->epochManager);
    ...
    if (packagerEnabled) {
        ...
        result->setPackagerOptions(
            ...
            packagerLayers, errorHint, genPackages, deleteUnusedImports);
    }
...
GlobalState::copyForSlowPath(const vector<string> &extraPackageFilesDirectoryUnderscorePrefixes,
                             ...
                             string errorHint, bool genPackages, bool deleteUnusedImports) const {
    auto result = make_unique<GlobalState>(this->errorQueue, this->epochManager);
...
void GlobalState::setPackagerOptions(const vector<string> &extraPackageFilesDirectoryUnderscorePrefixes,
    ...
    packageDB_.deleteUnusedImports_ = deleteUnusedImports;
