...
public:
    ...
    static SymbolRef Proc0() {
        return SymbolRef(nullptr, MAX_SYNTHETIC_SYMBOLS - MAX_PROC_ARITY * 4 - 4);
    }
    ...
    static SymbolRef Proc(int argc) {
        ...
        return SymbolRef(nullptr, Proc0()._id + argc * 4);
    }
    ...
    static SymbolRef last_synthetic_sym() {
        ENFORCE(last_proc()._id == MAX_SYNTHETIC_SYMBOLS - 4);
