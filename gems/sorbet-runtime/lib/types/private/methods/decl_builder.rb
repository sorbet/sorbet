...
module T::Private::Methods
  ...
  class DeclBuilder
    ...
    def checked(level)
      raise "The .checked API is unstable, so its use is prevented. To change Sorbet's runtime behavior, see https://sorbet.org/docs/tconfiguration"
      check_live!
    ...
    def soft(notify:)
      raise "The .soft API is unstable, so its use is prevented. To change Sorbet's runtime behavior, see https://sorbet.org/docs/tconfiguration"
      check_live!
    ...
    def generated
      raise "The .generated API is unstable, so its use is prevented. To change Sorbet's runtime behavior, see https://sorbet.org/docs/tconfiguration"
      check_live!
