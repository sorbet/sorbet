...
def register_ruby_dependencies():
    ...
    http_archive(
        name = "libyaml",
        urls = "https://github.com/yaml/libyaml/releases/download/{}/yaml-{}.tar.gz".format(libyaml_version, libyaml_version),
    ...
    http_archive(
        name = "libffi",
        urls = "https://github.com/libffi/libffi/releases/download/v{}/libffi-{}.tar.gz".format(libffi_version, libffi_version),
    ...
    http_file(
        ...
        urls = "https://rubygems.org/downloads/rubygems-update-3.5.4.gem",
    ...
    http_file(
        ...
        urls = "https://rubygems.org/downloads/rubygems-update-3.3.3.gem",
    ...
    http_archive(
        ...
        urls = "https://cache.ruby-lang.org/pub/ruby/3.1/ruby-3.1.4.tar.gz",
    ...
    http_archive(
        ...
        urls = "https://cache.ruby-lang.org/pub/ruby/3.3/ruby-3.3.1.tar.gz",
