...
def register_sorbet_dependencies():
    ...
    http_archive(
        ...
        # llvm 15.0.7 - matching the toolchain version
        urls = _github_public_urls("llvm/llvm-project/archive/llvmorg-15.0.7.tar.gz"),
        ...
        strip_prefix = "llvm-project-llvmorg-15.0.7/llvm",
    )
    ...
    # OpenSSL for building Ruby for the compiler
    ...
    # Ruby dependencies (needed for the compiler)
