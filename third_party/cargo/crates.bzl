...
def raze_fetch_remote_crates():
    ...
    _new_http_archive(
        ...
        url = "https://crates.io/api/v1/crates/bytecount/0.6.0/download",
    ...
    _new_http_archive(
        ...
        url = "https://crates.io/api/v1/crates/proc-macro2/1.0.10/download",
    ...
    _new_http_archive(
        ...
        url = "https://crates.io/api/v1/crates/quote/1.0.3/download",
