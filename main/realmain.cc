...
int realmain(int argc, char *argv[]) {
    ...
    if (opts.runLSP) {
        ...
        // We disable tree leaking if we're targeting emscripten, or if we're typechecking by package dependencies. The
        // latter is so that we reuse memory as we traverse the package graph.
