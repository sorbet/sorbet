...
bool LSPIndexer::canTakeFastPathInternal(
    ...
    for (auto &f : changedFiles) {
        ...
        ENFORCE(oldHash.definitions.hierarchyHash != core::LocalSymbolTableHashes::HASH_STATE_NOT_COMPUTED);
        if (newHash.definitions.hierarchyHash == core::LocalSymbolTableHashes::HASH_STATE_INVALID) {
            ENFORCE(newHash.definitions.classModuleHash == core::LocalSymbolTableHashes::HASH_STATE_INVALID);
            ENFORCE(newHash.definitions.typeArgumentHash == core::LocalSymbolTableHashes::HASH_STATE_INVALID);
            ENFORCE(newHash.definitions.typeMemberHash == core::LocalSymbolTableHashes::HASH_STATE_INVALID);
            ENFORCE(newHash.definitions.fieldHash == core::LocalSymbolTableHashes::HASH_STATE_INVALID);
            ENFORCE(newHash.definitions.methodHash == core::LocalSymbolTableHashes::HASH_STATE_INVALID);
