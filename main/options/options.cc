...
const vector<PrintOptions> print_options({
    ...
    {"desugar-tree", &Printers::Desugared},
    {"desugar-tree-raw", &Printers::DesugaredRaw},
    ...
    {"flatten-tree", &Printers::FlattenedTree, true},
    {"flatten-tree-raw", &Printers::FlattenedTreeRaw, true},
    {"ast", &Printers::FlattenedTree, true},
    {"ast-raw", &Printers::FlattenedTreeRaw, true},
