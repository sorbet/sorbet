...
core::StrictLevel decideStrictLevel(const core::GlobalState &gs, const core::FileRef file,
    ...
    if (fnd != opts.strictnessOverrides.end()) {
        if (fnd->second == fileData.originalPragma) {
            core::ErrorRegion errs(gs, file);
        ...
        if (fileData.originalPragma == core::StrictLevel::None) {
            level = core::StrictLevel::False;
        } else {
            level = fileData.originalPragma;
        }
    }
...
void incrementStrictLevelCounter(core::StrictLevel level) {
    switch (level) {
        ...
        case core::StrictLevel::Ignore:
            prodCounterInc("types.input.files.pragma.ignore");
            break;
        case core::StrictLevel::Internal:
            Exception::raise("Should never happen");
            break;
        case core::StrictLevel::False:
            prodCounterInc("types.input.files.pragma.false");
            break;
        case core::StrictLevel::True:
            prodCounterInc("types.input.files.pragma.true");
            break;
        case core::StrictLevel::Strict:
            prodCounterInc("types.input.files.pragma.strict");
            break;
        case core::StrictLevel::Strong:
            prodCounterInc("types.input.files.pragma.strong");
            break;
        case core::StrictLevel::Max:
            Exception::raise("Should never happen");
            break;
        case core::StrictLevel::Autogenerated:
            prodCounterInc("types.input.files.pragma.autogenerated");
            break;
        case core::StrictLevel::Stdlib:
            prodCounterInc("types.input.files.pragma.stdlib");
            break;
    }
}
