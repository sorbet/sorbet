...
## `ast.c`
* [   ] `rb_ast_node_type` (`Node#type`)
* [   ] `rb_ast_node_first_lineno` (`Node#first_lineno`)
* [   ] `rb_ast_node_first_column` (`Node#first_column`)
* [   ] `rb_ast_node_last_lineno` (`Node#last_lineno`)
* [   ] `rb_ast_node_last_column` (`Node#last_column`)
* [   ] `rb_ast_node_children` (`Node#children`)
* [   ] `rb_ast_node_inspect` (`Node#inspect`)
...
## `cont.c`
* [   ] `rb_fiber_init` (`Fiber#initialize`)
...
## `gc.c`
* [   ] `gc_start_internal` (`GC#garbage_collect`)
...
* [   ] `rb_hash_initialize_copy` (`Hash#initialize_copy`)
...
* [✔  ] `rb_method_call` (`Method#call`)
* [✔  ] `rb_method_call` (`Method#===`)
...
## `vm_eval.c`
* [✔  ] `rb_obj_instance_eval` (`BasicObject#instance_eval`)
* [✔  ] `rb_obj_instance_exec` (`BasicObject#instance_exec`)
* [✔  ] `rb_f_send` (`BasicObject#__send__`)
* [✔  ] `rb_f_send` (`Kernel#send`)
* [   ] `rb_f_public_send` (`Kernel#public_send`)
* [✔  ] `rb_mod_module_exec` (`Module#module_exec`)
* [✔  ] `rb_mod_module_exec` (`Module#class_exec`)
* [✔  ] `rb_mod_module_eval` (`Module#module_eval`)
* [✔  ] `rb_mod_module_eval` (`Module#class_eval`)
...
* [   ] `tracepoint_enable_m` (`TracePoint#__enable`)
* [   ] `tracepoint_disable_m` (`TracePoint#disable`)
* [✔  ] `rb_tracepoint_enabled_p` (`TracePoint#enabled?`)
* [   ] `tracepoint_inspect` (`TracePoint#inspect`)
* [   ] `tracepoint_attr_event` (`TracePoint#event`)
* [   ] `tracepoint_attr_lineno` (`TracePoint#lineno`)
* [   ] `tracepoint_attr_path` (`TracePoint#path`)
* [   ] `tracepoint_attr_parameters` (`TracePoint#parameters`)
* [   ] `tracepoint_attr_method_id` (`TracePoint#method_id`)
* [   ] `tracepoint_attr_callee_id` (`TracePoint#callee_id`)
* [   ] `tracepoint_attr_defined_class` (`TracePoint#defined_class`)
* [   ] `tracepoint_attr_binding` (`TracePoint#binding`)
* [   ] `tracepoint_attr_self` (`TracePoint#self`)
* [   ] `tracepoint_attr_return_value` (`TracePoint#return_value`)
* [   ] `tracepoint_attr_raised_exception` (`TracePoint#raised_exception`)
* [   ] `tracepoint_attr_eval_script` (`TracePoint#eval_script`)
* [   ] `tracepoint_attr_instruction_sequence` (`TracePoint#instruction_sequence`)
